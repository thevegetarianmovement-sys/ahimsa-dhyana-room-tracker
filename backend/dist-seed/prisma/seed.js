...
async function main() {
    ...
    const defaultPasswordAdmin = await bcryptjs_1.default.hash(adminPasswordRaw || 'password123', 10);
    const defaultPasswordVolunteer = await bcryptjs_1.default.hash(volunteerPasswordRaw || 'password123', 10);
